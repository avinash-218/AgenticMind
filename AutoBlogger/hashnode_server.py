...
async def create_draft_article(title: str, content_markdown: str, subtitle: str = "", tags: str = "") -> str:
    ...
    try:
        ...
        if not draft:
            logger.info("Failed to create draft.")
...
async def publish_draft_article(draft_id: str) -> str:
    ...
    try:
        ...
        if not post:
            logger.info("Failed to publish draft.")
...
async def update_post_article(
    ...
    try:
        ...
        if not post:
            logger.info("Failed to update post.")
...
async def remove_post_article(post_id: str) -> str:
    ...
    try:
        ...
        if not post:
            logger.info("Failed to remove post.")
...
"""
        logger.info("Publication info fetched successfully.")
...
async def get_publication_posts(host: str, limit: int = 10) -> str:
    ...
    try:
        ...
        if not posts:
            logger.info("No posts found for publication.")
...
"""
        logger.info("Publication posts fetched successfully.")
